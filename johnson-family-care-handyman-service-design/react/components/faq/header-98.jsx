        ...
        <div className="relative z-10 flex min-h-[32rem] flex-col items-center justify-center p-8 text-center md:min-h-[40rem] md:p-16">
          <div className="w-full max-w-lg">
            <h1 className="mb-5 text-h1 font-bold text-white md:mb-6">
              Straight answers from a family of tradesmen
            </h1>
            <p className="text-medium text-white">
              We know home repairs can raise a lot of questions. Here are the
              ones we hear most often from homeowners across Western Sydney.
            </p>
          </div>
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4 md:mt-8">
            ...
            <Button title="Call us" variant="secondary-alt">
              Call us
            </Button>
          </div>
        </div>
