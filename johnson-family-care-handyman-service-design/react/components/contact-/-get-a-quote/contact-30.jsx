    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28 scheme-3">
      <div className="container">
        <div className="mb-12 flex max-w-lg flex-col justify-start md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4">Service area</p>
          <h2 className="mb-5 text-h2 font-bold md:mb-6">Locations</h2>
          <p className="text-medium">
            We work right across Western Sydney and the Hills District.
          </p>
        </div>
        <Tabs
          defaultValue="tab-1"
          ...
          <TabsList className="relative grid h-full auto-cols-fr grid-cols-1 gap-x-4">
            ...
            >
              <div className="text-left">
                ...
                <p className="inline-block whitespace-normal">
                  Penrith, Emu Plains, Glenmore Park and surrounds
                </p>
            ...
            >
              <div className="text-left">
                ...
                <p className="inline-block whitespace-normal">
                  Blacktown, Seven Hills, Quakers Hill and surrounds
                </p>
                <div className="mt-5 font-semibold md:mt-6">
                  <p>Get directions</p>
                </div>
            ...
            >
              <div className="text-left">
                ...
                <p className="inline-block whitespace-normal">
                  Parramatta, Baulkham Hills, Castle Hill and surrounds
                </p>
                <div className="mt-5 font-semibold md:mt-6">
                  <p>Get directions</p>
                </div>
