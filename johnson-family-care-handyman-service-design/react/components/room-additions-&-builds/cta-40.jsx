        ...
        <Card className="grid auto-cols-fr grid-cols-1 lg:grid-cols-2">
          <div className="flex flex-col justify-center p-8 md:p-12">
            <h2 className="mb-5 text-h2 font-bold md:mb-6">
              Ready to add that room?
            </h2>
            <p className="text-medium">
              Call us or send a quick message and we will arrange a free on-site
              quote
            </p>
            <div className="mt-6 w-full max-w-sm md:mt-8">
              ...
              <p className="text-tiny">
                By clicking Get quote you're confirming that you agree with our
